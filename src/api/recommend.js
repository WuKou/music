...
export function getRecommend () {
  const url = debug ? '/api/getTopBanner' : '106.53.71.64/music/api/getTopBanner'
...
export function getDiscList() {
  const url = debug ? '/api/getDiscList' : '106.53.71.64/music/api/getDiscList'
...
export function getSongList(disstid) {
  const url = debug ? '/api/getSongList' : '106.53.71.64/music/api/getSongList'
