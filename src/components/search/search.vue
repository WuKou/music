<template>
  <div class="search">
    <div class="search-box-wrapper"><search-box @query="onQueryChange" ref="searchBox"></search-box></div>
      ...
      <scroll class="shortcut" :data="shortcut" ref="shortcut">
        <div>
          ...
          <div class="search-history" v-show="searchHistory.length">
            ...
            <search-list :searchHistory="searchHistory" @selectItem="selectSearchHistory" @deleteOne="deleteOne"></search-list>
          </div>
        </div>
      </scroll>
    </div>
    ...
    <confirm content="确定清空搜索记录吗？" confirmBtnText="清空" @confirm="clear" @cancel="cancelClear" ref="confirm"></confirm>
